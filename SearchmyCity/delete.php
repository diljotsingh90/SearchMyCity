...
<body>
    ...
    <body><div id="d_out">
    <div id="d_in">
        <h1 class="whiteheadings">Delete Account</h1>
        
        <form class="fdelete"action="assets/deleteuser.php" method="post" >
                
                    <div class="form-group">
                    <input class="form-control formfield" type="password" name="pass" placeholder="Re-enter Password" id="text-input">
                </div>
                <br>
                     <button name="submit" id = "sbtn" class="btn btn-primary btn-block btn-lg btn-signin" type="submit">Delete</button>
